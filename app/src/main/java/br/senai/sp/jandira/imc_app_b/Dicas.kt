...
fun getDicas() : List<String>{
    val dicas = listOf(
                listOf("Alimente -se melhor","Reduza alimentos com gordura,açúcar e sal. Tenha sempre frutas,verduras e legumes na alimentção diária."),
